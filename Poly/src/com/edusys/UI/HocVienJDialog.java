    ...
    void fillTableNguoiHoc(){
        ...
        for (int i = 0; i <list.size(); i++) {
            ...
            Object[] rowData = new Object[]{
                ...
                nguoiHoc.getGioiTinh() == true ? "Nam":"Nữ",
...
//        fillTableHocVien();
   int n = tblHocVien.getRowCount();
        String rs = DialogHelper.prompt(this, "Mời nhập điểm");
        for (int i = 0; i < n; i++) {
            double diem = Double.parseDouble(rs);
            int mahv = (Integer) tblHocVien.getValueAt(tblHocVien.getSelectedRow(), 1);
            HocVien hv = hvdao.selectBYId(mahv);
            hv.setDiem(diem);
            hvdao.update(hv);
        }
